# tuples of name, url (optional), HTML
...
<h2>Purposes of the web site</h2>
...
<h2>Principles</h2>
<p>When using the message boards and private messages, the following principles
 must be remembered:</p>
<ol>
  <li>Colossians 4:6 <i>"Let your conversation be always full of grace,
    seasoned with salt, so that you may know how to answer everyone".</i></li>
  <li>Romans 12:17,18 <i>"Do not repay evil for evil.  Be careful to do what is right
   in the eyes of everybody. <b>If it is possible, as far as it depends on you,
    live at peace with everyone</b>."</i></li>
...
<p>Any use of this web site in ways which contradict or hinder the purposes
 and principles above is not allowed.  More explicitly:</p>
...
<p>To sign up as a member, you must provide an e-mail address.
 This e-mail address will never be given to any third party.
 It may very occasionally be used to e-mail all signed up members with
 important information, or to e-mail an individual user with
 regard to their use of the web site.</p>

<p>By default your e-mail address is not visible to other users.
 You can opt to have it visible, and in this case it will be
 displayed in a manner that makes it virtually 'spam proof', so
 that the e-mail address will not be collected by spammers from
...
<h2>Disclaimer</h2>
<p>The services on this web site are provided for free, and there is
 therefore no warranty or guarantee for any part of them.  Use of this web
 site is at your own risk, and CCIW shall in no event be liable
 for any damages incurred through use of this site.</p>

"""))

html.append(('doctrinal_basis', '/info/doctrinal-basis/', 'Doctrinal Basis', """
<p>Below is the doctrinal basis of CCIW, to which all the directors subscribe and which forms the basis of what we seek to do
 and teach.</p>
...
html.append(('legal_info', '/info/legal/','Legal Information', """
<h2>Insurance</h2>
<p>Many people ask about insurance on camp. </p>
...
campers should they have an accident which was due
to the <strong>negligence</strong> of CCIW or any of the camp leaders or
officers.  This sort of insurance also provides 3rd party cover for the camp for
situations where we may be liable for damage incurred by people not
connected with the camp. Standard cover up to &pound;1,000,000 is provided.</p>

<p>If anyone should want to see this policy
it will be available on camp.</p>

<p>Personal Accident cover is a
"no-blame" type of insurance which will pay out
in the case of injury even if it is a simple accident.
i.e. no blame attached. </p>

<p>CCIW does not provide this type of insurance cover but if you wish to have it
tick the relevant question on the Booking Form and we will send you information
for you to obtain your own cover.</p>

<p>Also, note that insurance for adventure activities is provided by the Licensed Activity Provider.</p>

<p>Our insurance company is Ansvar Ltd.</p>
"""))

html.append(('about_camp_general', '/info/about-camp/', 'About camp', """

<div style='text-align: center'><strong>Camp is really great fun, but so much more</strong></div>

<h2>What is camp really about?</h2>
<p>Well, there are lots of different answers.</p>

<p>Some will say <strong>friendship</strong>, and certainly we know of some 
...
everyone.  There are optional extras including rock climbing, pony trekking etc.  
Please bring extra pocket money for these.</p>

<p>Whilst friendship and fun are really important, at the heart of camp is a person, <strong>Jesus Christ</strong>.  
He makes camp special in so many ways but especially as His gospel is taught and 
explained in the morning services and tent Bible studies.</p>

<h2>The Aim</h2>
<p>The aim of the camps is the presentation of the Christian faith to young people in 
the context of a safe &amp; healthy outdoor camp environment.</p>

<p>Safety and a wholesome environment for campers is paramount.  For this reason the 
teams will be led by experienced leaders and where possible a husband and wife team.
  Quite often this means that camp life will be enhanced by the presence of young children on site.</p>

<p>The programme will include a morning service and evening tent Bible study every day except 
Sunday, which is kept special with two services and a quiet programme in between.</p>
...
<p>We can provide some transport to camp, which will be available from 
LONGWOOD DRIVE NEXT TO ASDA NORTH CARDIFF J32 M4. Please indicate on the booking form if you 
require this. The cost is &pound;15 and this must be sent with the booking form.</p>

<p>Transport will also be provided from the station/bus stops in Tywyn/Barmouth to 
the camp sites if you let us know when you require it.</p>

<h2>Insurance <a href="/info/legal/" title="Legal information">(more info...)</a></h2>
<p>CCIW is insured for public liability.  Public liability is a cover which provides protection 
for campers should they have an accident which was due to the negligence of the 
leaders or organisers of Christian Camps in Wales.</p>

<p>The camp fee does not include personal accident cover for campers, i.e. if a camper recieves 
an injury on camp for which CCIW is not liable, there will be no entitlement to 
any payment from CCIW's insurers.</p>
...
or the option to go on a waiting list.  But if you accept an alternative camp you 
cannot remain on the waiting list of your first choice as well.</p>
...
html.append(('info_index','/info/', 'Information', """
...
html.append(('home_page', '/', 'Christian Camps in Wales', """
<p>CCIW is a charitable company that runs outdoor camps on a number of sites in Wales.
 The camps provide great outdoor fun, but with God and the Bible at the centre of each day.</p>
