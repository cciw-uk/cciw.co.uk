...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cciwmain_photo', 'forums_photo')
        db.rename_table('cciwmain_poll', 'forums_poll')
        db.rename_table('cciwmain_topic', 'forums_topic')
        db.rename_table('cciwmain_award', 'forums_award')
        db.rename_table('cciwmain_post', 'forums_post')
        db.rename_table('cciwmain_polloption', 'forums_polloption')
        db.rename_table('cciwmain_forum', 'forums_forum')
        db.rename_table('cciwmain_personalaward', 'forums_personalaward')
        db.rename_table('cciwmain_message', 'forums_message')
        db.rename_table('cciwmain_voteinfo', 'forums_voteinfo')
        db.rename_table('cciwmain_member', 'forums_member')
        db.rename_table('cciwmain_member_permissions', 'forums_member_permissions')
        db.rename_table('cciwmain_gallery', 'forums_gallery')
        db.rename_table('cciwmain_newsitem', 'forums_newsitem')
        db.rename_table('cciwmain_permission', 'forums_permission')

    def backwards(self, orm):

        db.rename_table('forums_photo', 'cciwmain_photo')
        db.rename_table('forums_poll', 'cciwmain_poll')
        db.rename_table('forums_topic', 'cciwmain_topic')
        db.rename_table('forums_award', 'cciwmain_award')
        db.rename_table('forums_post', 'cciwmain_post')
        db.rename_table('forums_polloption', 'cciwmain_polloption')
        db.rename_table('forums_forum', 'cciwmain_forum')
        db.rename_table('forums_personalaward', 'cciwmain_personalaward')
        db.rename_table('forums_message', 'cciwmain_message')
        db.rename_table('forums_voteinfo', 'cciwmain_voteinfo')
        db.rename_table('forums_member', 'cciwmain_member')
        db.rename_table('forums_member_permissions', 'cciwmain_member_permissions')
        db.rename_table('forums_gallery', 'cciwmain_gallery')
        db.rename_table('forums_newsitem', 'cciwmain_newsitem')
        db.rename_table('forums_permission', 'cciwmain_permission')
