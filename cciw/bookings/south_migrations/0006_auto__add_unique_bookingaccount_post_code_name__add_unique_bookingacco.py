...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'BookingAccount', fields ['post_code', 'name']
        db.create_unique('bookings_bookingaccount', ['post_code', 'name'])

        # Adding unique constraint on 'BookingAccount', fields ['name', 'email']
        db.create_unique('bookings_bookingaccount', ['name', 'email'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BookingAccount', fields ['name', 'email']
        db.delete_unique('bookings_bookingaccount', ['name', 'email'])

        # Removing unique constraint on 'BookingAccount', fields ['post_code', 'name']
        db.delete_unique('bookings_bookingaccount', ['post_code', 'name'])
