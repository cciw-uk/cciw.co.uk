...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Delete Payment objects that weren't cleaned up before

        # We need full model and the ContentType mechanism here, so do a real import
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 23, 24, 21, 507491)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 23, 24, 21, 507368)'}),
