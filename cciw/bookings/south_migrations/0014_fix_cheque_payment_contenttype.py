...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ct = orm['contenttypes.ContentType'].objects.get(model='chequepayment')
        ct2 = orm['contenttypes.ContentType'].objects.get(model='manualpayment')
        orm['bookings.Payment'].objects.filter(origin_type=ct).update(origin_type=ct2)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 22, 57, 58, 554515)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 22, 57, 58, 554386)'}),
    ...
    complete_apps = ['bookings', 'contenttypes']
