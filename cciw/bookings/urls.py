...
urlpatterns = \
    patterns('cciw.bookings.views',
             ...
             (r'^v/(?P<account_id>[0-9A-Za-z]+)-(?P<token>.+)/$', 'verify_email_and_start'),
             (r'^p/(?P<account_id>[0-9A-Za-z]+)-(?P<token>.+)/$', 'verify_email_and_pay'),
             ...
             (r'^all-places-json/$', 'all_places_json'),
             (r'^account-json/$', 'account_json'),
             (r'^all-account-json/$', 'all_accounts_json'),
