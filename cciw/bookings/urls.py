...
urlpatterns = [
    ...
    url(r'^v/(?P<token>.+)/$', views.verify_email_and_start, name="cciw-bookings-verify_email_and_start"),
    url(r'^p/(?P<token>.+)/$', views.verify_email_and_pay, name="cciw-bookings-verify_email_and_pay"),
