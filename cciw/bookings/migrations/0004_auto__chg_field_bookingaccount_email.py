...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookingAccount.email'
        db.alter_column('bookings_bookingaccount', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'BookingAccount.email'
        db.alter_column('bookings_bookingaccount', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True))
