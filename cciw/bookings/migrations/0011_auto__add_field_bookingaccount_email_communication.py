...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BookingAccount.email_communication'
        db.add_column('bookings_bookingaccount', 'email_communication', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BookingAccount.email_communication'
        db.delete_column('bookings_bookingaccount', 'email_communication')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 31, 14, 11, 58, 190477)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 31, 14, 11, 58, 190343)'}),
