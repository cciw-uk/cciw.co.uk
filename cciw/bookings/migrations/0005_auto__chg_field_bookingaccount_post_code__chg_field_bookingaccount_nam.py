...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BookingAccount.post_code'
        db.alter_column('bookings_bookingaccount', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'BookingAccount.name'
        db.alter_column('bookings_bookingaccount', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'BookingAccount.post_code'
        db.alter_column('bookings_bookingaccount', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'BookingAccount.name'
        db.alter_column('bookings_bookingaccount', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
