    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("address_city", models.CharField(default="", max_length=255, verbose_name="town/city")),
                (
                    "address_country",
                ...
                ("address_line2", models.CharField(blank=True, max_length=255, verbose_name="address line 2")),
                ("contact_city", models.CharField(default="", max_length=255, verbose_name="town/city")),
                (
                    "contact_country",
                    django_countries.fields.CountryField(default="GB", max_length=2, null=True, verbose_name="country"),
                ),
                ("contact_county", models.CharField(blank=True, max_length=255, verbose_name="county/state")),
                ("contact_line1", models.CharField(default="", max_length=255, verbose_name="address line 1")),
                ("contact_line2", models.CharField(blank=True, max_length=255, verbose_name="address line 2")),
                ("gp_city", models.CharField(default="", max_length=255, verbose_name="town/city")),
                (
                    "gp_country",
                    django_countries.fields.CountryField(default="GB", max_length=2, null=True, verbose_name="country"),
                ),
                ("gp_county", models.CharField(blank=True, max_length=255, verbose_name="county/state")),
                ("gp_line1", models.CharField(default="", max_length=255, verbose_name="address line 1")),
