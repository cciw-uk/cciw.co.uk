...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Booking.contact_name'
        db.delete_column('bookings_booking', 'contact_name')

        # Adding field 'Booking.contact_address'
        db.add_column('bookings_booking', 'contact_address', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'Booking.contact_post_code'
        db.add_column('bookings_booking', 'contact_post_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Booking.contact_name'
        db.add_column('bookings_booking', 'contact_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Deleting field 'Booking.contact_address'
        db.delete_column('bookings_booking', 'contact_address')

        # Deleting field 'Booking.contact_post_code'
        db.delete_column('bookings_booking', 'contact_post_code')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 27, 15, 49, 1, 100267)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 27, 15, 49, 1, 100045)'}),
