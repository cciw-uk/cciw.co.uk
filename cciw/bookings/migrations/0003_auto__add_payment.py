...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bookings_payment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookings.BookingAccount'])),
            ('origin_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('origin_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('processed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('bookings', ['Payment'])


    def backwards(self, orm):
        
        # Deleting model 'Payment'
        db.delete_table('bookings_payment')
