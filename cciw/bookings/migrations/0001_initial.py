    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('south_wales_transport', models.BooleanField(default=False, verbose_name='require transport from South Wales')),
                ...
                ('price_type', models.PositiveSmallIntegerField(choices=[(0, 'Full price'), (1, '2nd child discount'), (2, '3rd child discount'), (3, 'Custom discount')])),
                ...
                ('state', models.IntegerField(help_text="<ul><li>To book, set to 'Booked' <b>and</b> ensure 'Booking expires' is empty</li><li>For people paying online who have been stopped (e.g. due to having a custom discount or serious illness or child too young etc.), set to 'Manually approved' to allow them to book and pay</li><li>If there are queries before it can be booked, set to 'Information complete'</li></ul>", choices=[(0, 'Information complete'), (1, 'Manually approved'), (2, 'Booked'), (3, 'Cancelled - deposit kept'), (4, 'Cancelled - half refund (pre 2015 only)'), (5, 'Cancelled - full refund')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_type', models.PositiveSmallIntegerField(choices=[(0, 'Full price'), (1, '2nd child discount'), (2, '3rd child discount'), (4, 'South wales transport surcharge (pre 2015)'), (5, 'Deposit'), (6, 'Early bird discount')])),
        ...
        migrations.AlterUniqueTogether(
            name='price',
            unique_together=set([('year', 'price_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='bookingaccount',
