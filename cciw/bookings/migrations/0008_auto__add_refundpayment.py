...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RefundPayment'
        db.create_table('bookings_refundpayment', (
        ...
        db.send_create_signal('bookings', ['RefundPayment'])


    def backwards(self, orm):
        
        # Deleting model 'RefundPayment'
        db.delete_table('bookings_refundpayment')
