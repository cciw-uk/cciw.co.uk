...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Camp', fields ['number', 'year']
        db.create_unique('cciwmain_camp', ['number', 'year'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Camp', fields ['number', 'year']
        db.delete_unique('cciwmain_camp', ['number', 'year'])
