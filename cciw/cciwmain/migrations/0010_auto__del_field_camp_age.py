...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Camp.age'
        db.delete_column('cciwmain_camp', 'age')


    def backwards(self, orm):

        # Adding field 'Camp.age'
        db.add_column('cciwmain_camp', 'age', self.gf('django.db.models.fields.CharField')(default='', max_length=3), keep_default=False)

        orm.Camp.objects.filter(minimum_age=11).update(age='Jnr')
        orm.Camp.objects.filter(minimum_age=16).update(age='Snr')
