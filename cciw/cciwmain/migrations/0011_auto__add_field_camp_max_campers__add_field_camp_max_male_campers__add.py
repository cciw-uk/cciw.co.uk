...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Camp.max_campers'
        db.add_column('cciwmain_camp', 'max_campers', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=80), keep_default=False)

        # Adding field 'Camp.max_male_campers'
        db.add_column('cciwmain_camp', 'max_male_campers', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=60), keep_default=False)

        # Adding field 'Camp.max_female_campers'
        db.add_column('cciwmain_camp', 'max_female_campers', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=60), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Camp.max_campers'
        db.delete_column('cciwmain_camp', 'max_campers')

        # Deleting field 'Camp.max_male_campers'
        db.delete_column('cciwmain_camp', 'max_male_campers')

        # Deleting field 'Camp.max_female_campers'
        db.delete_column('cciwmain_camp', 'max_female_campers')
