...
urlpatterns = [
    ...
    path('leaders/request-dbs-form-action/<int:application_id>/', views.request_dbs_form_action, name="cciw-officers-request_dbs_form_action"),
    ...
    path('leaders/officer-stats-download/<yyyy:year>/', views.officer_stats_download, name="cciw-officers-officer_stats_download"),
    path('leaders/officer-stats-trend/<yyyy:start_year>-<yyyy:end_year>/', views.officer_stats_trend, name="cciw-officers-officer_stats_trend"),
    path('leaders/officer-stats-trend-download/<yyyy:start_year>-<yyyy:end_year>/', views.officer_stats_trend_download, name="cciw-officers-officer_stats_trend_download"),

    # References
    path('ref/<int:referee_id>-<optstr:prev_ref_id>-<hash>/', views.create_reference_form, name="cciw-officers-create_reference_form"),
    ...
    path('bookings/reports/<yyyy:year>/', views.booking_secretary_reports, name="cciw-officers-booking_secretary_reports"),
    ...
    path('bookings/booking-summary-stats-download/<yyyy:start_year>-<yyyy:end_year>/', views.booking_summary_stats_download, name="cciw-officers-booking_summary_stats_download"),
    path('bookings/brochure-mailing-list/<yyyy:year>/', views.brochure_mailing_list, name="cciw-officers-brochure_mailing_list"),
