...
urlpatterns = [
    ...
    url(r'^leaders/export-sharable-transport-details/(?P<year>\d{4})/(?P<number>\d+)/$', views.export_sharable_transport_details, name="cciw-officers-export_sharable_transport_details"),
    url(r'^leaders/remove-officer/(?P<year>\d{4})/(?P<number>\d+)/$', views.remove_officer, name="cciw-officers-remove_officer"),
    url(r'^leaders/add-officers/(?P<year>\d{4})/(?P<number>\d+)/$', views.add_officers, name="cciw-officers-add_officers"),
