...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.date_added'
        db.add_column('officers_invitation', 'date_added', self.gf('django.db.models.fields.DateField')(default=datetime.date(1970, 1, 1)), keep_default=False)

        # Invent more sensible values for date_added field.  We'll use one day
        # after the previous camp finished (which works for all Invitation
        # objects in our db).

        from datetime import timedelta
        for i in orm['officers.Invitation'].objects.all():
            i.date_added = i.camp.previous_camp.end_date + timedelta(1)
            i.save()

    def backwards(self, orm):
        
        # Deleting field 'Invitation.date_added'
        db.delete_column('officers_invitation', 'date_added')
