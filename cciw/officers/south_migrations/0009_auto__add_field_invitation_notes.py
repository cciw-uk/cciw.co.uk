...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.notes'
        db.add_column('officers_invitation', 'notes', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invitation.notes'
        db.delete_column('officers_invitation', 'notes')
