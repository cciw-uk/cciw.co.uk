...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.camp'
        db.alter_column('officers_application', 'camp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cciwmain.Camp']))


    def backwards(self, orm):
        
        # Changing field 'Application.camp'
        db.alter_column('officers_application', 'camp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cciwmain.Camp'], null=True))
