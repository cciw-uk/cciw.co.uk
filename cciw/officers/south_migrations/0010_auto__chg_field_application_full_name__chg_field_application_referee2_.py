...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.full_name'
        db.alter_column('officers_application', 'full_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=100))

        # Changing field 'Application.referee2_name'
        db.alter_column('officers_application', 'referee2_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=100))

        # Changing field 'Application.full_maiden_name'
        db.alter_column('officers_application', 'full_maiden_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Application.referee1_name'
        db.alter_column('officers_application', 'referee1_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Application.full_name'
        db.alter_column('officers_application', 'full_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60))

        # Changing field 'Application.referee2_name'
        db.alter_column('officers_application', 'referee2_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60))

        # Changing field 'Application.full_maiden_name'
        db.alter_column('officers_application', 'full_maiden_name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'Application.referee1_name'
        db.alter_column('officers_application', 'referee1_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60))
    ...
    models = {
        ...
        'cciwmain.camp': {
            ...
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'null': 'True', 'related_name': "'camps_as_admin'", 'symmetrical': 'False', 'blank': 'True'}),
            'chaplain': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'camps_as_chaplain'", 'to': "orm['cciwmain.Person']", 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leaders': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cciwmain.Person']", 'null': 'True', 'related_name': "'camps_as_leader'", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'officers': ('django.db.models.fields.related.ManyToManyField', [], {'through': "orm['officers.Invitation']", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'online_applications': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'previous_camp': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'next_camps'", 'to': "orm['cciwmain.Camp']", 'blank': 'True'}),
        ...
        'cciwmain.site': {
            ...
            'slug_name': ('django.db.models.fields.SlugField', [], {'max_length': '25', 'unique': 'True', 'blank': 'True'})
        },
        ...
        'officers.application': {
            'Meta': {'ordering': "('-date_submitted', 'officer__first_name', 'officer__last_name')", 'object_name': 'Application'},
            ...
            'birth_date': ('cciw.officers.fields.RequiredDateField', [], {'null': 'True', 'default': 'None', 'blank': 'True'}),
            ...
            'full_maiden_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'full_name': ('cciw.officers.fields.RequiredCharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'referee1_name': ('cciw.officers.fields.RequiredCharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'referee2_name': ('cciw.officers.fields.RequiredCharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'officers.crbapplication': {
            'Meta': {'object_name': 'CRBApplication'},
            'completed': ('django.db.models.fields.DateField', [], {}),
            'crb_number': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'officer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'officers.crbformlog': {
            'Meta': {'object_name': 'CRBFormLog'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'officer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
        ...
        'officers.reference': {
            'Meta': {'ordering': "('application__date_submitted', 'application__officer__first_name', 'application__officer__last_name', 'referee_number')", 'unique_together': "(('application', 'referee_number'),)", 'object_name': 'Reference'},
        ...
        'officers.referenceform': {
            ...
            'reference_info': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['officers.Reference']", 'unique': 'True', 'related_name': "'_reference_form'"})
        }
    }
