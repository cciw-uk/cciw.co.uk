...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('officers_application', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('camp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cciwmain.Camp'], null=True)),
            ('officer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True)),
            ('full_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60, blank=True)),
            ('full_maiden_name', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('birth_date', self.gf('cciw.officers.fields.RequiredDateField')(default=None, null=True, blank=True)),
            ('birth_place', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60, blank=True)),
            ('address_firstline', self.gf('cciw.officers.fields.RequiredCharField')(max_length=40, blank=True)),
            ('address_town', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60, blank=True)),
            ('address_county', self.gf('cciw.officers.fields.RequiredCharField')(max_length=30, blank=True)),
            ('address_postcode', self.gf('cciw.officers.fields.RequiredCharField')(max_length=10, blank=True)),
            ('address_country', self.gf('cciw.officers.fields.RequiredCharField')(max_length=30, blank=True)),
            ('address_tel', self.gf('cciw.officers.fields.RequiredCharField')(max_length=22, blank=True)),
            ('address_mobile', self.gf('django.db.models.fields.CharField')(max_length=22, blank=True)),
            ('address_email', self.gf('cciw.officers.fields.RequiredEmailField')(max_length=75, blank=True)),
            ('address_since', self.gf('cciw.officers.fields.RequiredYyyyMmField')(max_length=7, blank=True)),
            ('address2_from', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('address2_to', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('address2_address', self.gf('cciw.officers.fields.AddressField')(blank=True)),
            ('address3_from', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('address3_to', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('address3_address', self.gf('cciw.officers.fields.AddressField')(blank=True)),
            ('christian_experience', self.gf('cciw.officers.fields.RequiredTextField')(blank=True)),
            ('youth_experience', self.gf('cciw.officers.fields.RequiredTextField')(blank=True)),
            ('youth_work_declined', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
            ('youth_work_declined_details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('relevant_illness', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
            ('illness_details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('employer1_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('employer1_from', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('employer1_to', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('employer1_job', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('employer1_leaving', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('employer2_name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('employer2_from', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('employer2_to', self.gf('cciw.officers.fields.YyyyMmField')(max_length=7, blank=True)),
            ('employer2_job', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('employer2_leaving', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('referee1_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60, blank=True)),
            ('referee1_address', self.gf('cciw.officers.fields.RequiredAddressField')(blank=True)),
            ('referee1_tel', self.gf('django.db.models.fields.CharField')(max_length=22, blank=True)),
            ('referee1_mobile', self.gf('django.db.models.fields.CharField')(max_length=22, blank=True)),
            ('referee1_email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('referee2_name', self.gf('cciw.officers.fields.RequiredCharField')(max_length=60, blank=True)),
            ('referee2_address', self.gf('cciw.officers.fields.RequiredAddressField')(blank=True)),
            ('referee2_tel', self.gf('django.db.models.fields.CharField')(max_length=22, blank=True)),
            ('referee2_mobile', self.gf('django.db.models.fields.CharField')(max_length=22, blank=True)),
            ('referee2_email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('crime_declaration', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
            ('crime_details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('court_declaration', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
            ('court_details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('concern_declaration', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
            ('concern_details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('allegation_declaration', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
            ('crb_check_consent', self.gf('cciw.officers.fields.RequiredNullBooleanField')(null=True, blank=True)),
        ...
        db.send_create_signal('officers', ['Application'])

        # Adding model 'Reference'
        db.create_table('officers_reference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['officers.Application'])),
            ('referee_number', self.gf('django.db.models.fields.SmallIntegerField')()),
        ...
        db.send_create_signal('officers', ['Reference'])

        # Adding unique constraint on 'Reference', fields ['application', 'referee_number']
        db.create_unique('officers_reference', ['application_id', 'referee_number'])

        # Adding model 'ReferenceForm'
        db.create_table('officers_referenceform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('referee_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('how_long_known', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('capacity_known', self.gf('django.db.models.fields.TextField')()),
            ('known_offences', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('known_offences_details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('capability_children', self.gf('django.db.models.fields.TextField')()),
            ('character', self.gf('django.db.models.fields.TextField')()),
            ('concerns', self.gf('django.db.models.fields.TextField')()),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateField')()),
            ('reference_info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['officers.Reference'])),
        ))
        db.send_create_signal('officers', ['ReferenceForm'])

        # Adding model 'Invitation'
        db.create_table('officers_invitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('officer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('camp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cciwmain.Camp'])),
        ))
        db.send_create_signal('officers', ['Invitation'])

        # Adding unique constraint on 'Invitation', fields ['officer', 'camp']
        db.create_unique('officers_invitation', ['officer_id', 'camp_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Invitation', fields ['officer', 'camp']
        db.delete_unique('officers_invitation', ['officer_id', 'camp_id'])

        # Removing unique constraint on 'Reference', fields ['application', 'referee_number']
        db.delete_unique('officers_reference', ['application_id', 'referee_number'])

        # Deleting model 'Application'
        db.delete_table('officers_application')

        # Deleting model 'Reference'
        db.delete_table('officers_reference')

        # Deleting model 'ReferenceForm'
        db.delete_table('officers_referenceform')

        # Deleting model 'Invitation'
        db.delete_table('officers_invitation')
    ...
    models = {
        ...
        'officers.referenceform': {
            ...
            'reference_info': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['officers.Reference']"})
        }
    }
