...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CRBFormLog'
        db.create_table('officers_crbformlog', (
        ...
        db.send_create_signal('officers', ['CRBFormLog'])


    def backwards(self, orm):
        
        # Deleting model 'CRBFormLog'
        db.delete_table('officers_crbformlog')
