...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CRBApplication'
        db.create_table('officers_crbapplication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('officer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('crb_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('completed', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('officers', ['CRBApplication'])


    def backwards(self, orm):
        
        # Deleting model 'CRBApplication'
        db.delete_table('officers_crbapplication')
