...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # We are removing thet link from Application to Camp, so that
        # 1) officers don't have to create multiple Applications if they
        ...
        # Deleting field 'Application.camp'
        db.delete_column('officers_application', 'camp_id')


    def backwards(self, orm):
        # We don't have enough information to re-create the ForeignKey value. A
        # dummy default value doesn't help, since we won't be able to satisfy
        # the unique constraint. So this will fail.

        # Adding field 'Application.camp'
        db.add_column('officers_application', 'camp', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cciwmain.Camp']), keep_default=False)

        # Adding unique constraint on 'Application', fields ['camp', 'officer']
        db.create_unique('officers_application', ['camp_id', 'officer_id'])
