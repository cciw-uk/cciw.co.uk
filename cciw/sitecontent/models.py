...
class HtmlChunk(models.Model):
    ...
    page_title = models.CharField("page title (for chunks that are pages)", max_length=100, blank=True)
    ...
    def render(self, request):
        ...
        if user and not user.is_anonymous and user.is_staff and user.has_perm("sitecontent.change_htmlchunk"):
            html += format_html(
